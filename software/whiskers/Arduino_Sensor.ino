/*please be informed that this code is a part of the examples that comes with the "Adafruit_MLX90393" libraray*/
/* An additional code is required to detect a sensor at the arduino peripheral, which captures the address of the sensor
that code has been uploaded as an seperate file and is a must to be executed before bootloading Arduino_Sensor.ino*/
